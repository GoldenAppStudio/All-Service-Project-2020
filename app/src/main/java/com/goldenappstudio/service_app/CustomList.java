...
public CustomList(Activity context,
        ...
        super(context, R.layout.customlayout_service_provider_profile, web);
...
public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.customlayout_service_provider_profile, null, true);
